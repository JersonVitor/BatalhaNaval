 ...
 * @author usuario
 */
public class Conexão extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conexão.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
